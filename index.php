...
?>
		<main class="main">
			<div class="navigation-pane text-center pt-3">
				...
				<hr>
				<ul>
					<li class="li-active"><a href="index.html">New Admission <i class="fa fa-user-plus"></i></a></li>
			...
			<div class="content-area text-white">
				<div class="container pl-4 pb-5">
					<div class="row">
						<div class="col">
							<h3 class="text-center mb-5">New Admission <i class="fa fa-user-plus"></i></h3>
							<form>
								<div class="form-group">
									<label for="srno">Sr. No</label>
									<input type="text" placeholder="Sr. No" class="form-control-plaintext text-white" id="srno" readonly>
								</div>
								  <div class="form-row">
								  ...
								  <div class="form-row">
									...
									<div class="form-row button-holder mt-3">
										<input type="submit" value="Submit" class="btn btn-outline-light ml-5">
