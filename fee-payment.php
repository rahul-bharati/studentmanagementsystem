	...
	<main class="main">
		<div class="navigation-pane text-center pt-3">
			...
			<ul>
				...
				<li class="li-active"><a href="fee-payment.html">Fee Payment <i class="fa fa-money"></i></a></li>
		...
		<div class="content-area text-white">
			<div class="container pl-4 pb-5">
				<div class="row">
					<div class="col">
						<h3 class="text-center mb-5">Fee Payment <i class="fa fa-money"></i></h3>
						<form>
							<div class="form-group">
								...
								<div class="form-row">
									<div class="col">
										<div class="form-group">
											...
											<input type="text" class="form-control" id="totalFee" placeholder="Total Fees">
										</div>
									</div>
									<div class="col">
										<div class="form-group">
											<label for="admDate">Admission Date</label>
											<input type="date" class="form-control" id="admDate" placeholder="Course Duration">
										</div>
									</div>
									<div class="col">
										<div class="form-group">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" id="bal" placeholder="Balance Amount">
								</div>
								<div class="form-row button-holder mt-3">
									<input type="submit" value="Pay fees" class="btn btn-outline-light ml-5">
									<input type="reset" value="Cancel" class="btn btn-outline-light ml-3">
								</div>
						</form>
					</div>
				</div>
