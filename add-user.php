	...
	<main class="main">
		<div class="navigation-pane text-center pt-3">
			...
			<ul>
				...
				<li class="li-active"><a href="add-user.html">Add Users <i class="fa fa-user"></i></a></li>
		...
		<div class="content-area text-white">
			<div class="container pl-4 pb-5">
				<div class="row">
					<div class="col">
						<h3 class="text-center mb-5">Add Users <i class="fa fa-user"></i></h3>
						<div class="user-div">
							<form>
								...
								<div class="form-group">
									...
									<input type="password" placeholder="Confirm Password" id="cpassword" class="form-control" required>
								</div>
								<div class="form-group">
