	...
	<main class="main">
		<div class="navigation-pane text-center pt-3">
			...
			<ul>
				...
				<li class="li-active"><a href="update-record.html">Update Record <i class="fa fa-edit"></i></a></li>
		...
		<div class="content-area text-white">
			<div class="container pl-4 pb-5">
				<div class="row">
					<div class="col">
						<h3 class="text-center mb-5">Update Record <i class="fa fa-edit"></i></h3>
						<form>
							<div class="form-group">
								...
								<div class="form-row button-holder mt-3">
									<input type="submit" value="Update Record" class="btn btn-outline-light ml-5">
